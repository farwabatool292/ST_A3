...
public class TC2 {
	  WebDriver driver;
		...
		{
			////define test case
		System.out.println(" Unit Test case 2");
		System.out.println("Checking Create User button in user management section is working correctly or not");
		...
		driver.manage().timeouts().pageLoadTimeout(Duration.ofMinutes(5));
		driver.navigate().refresh();
		//finding and clicking on Create user button
		System.out.println("Finding and clicking on Create User Button");
		driver.findElement(By.xpath("/html/body/ngx-app/div/ngx-pages/ngx-sample-layout/nb-layout/div/div/div/nb-sidebar[1]/div/div/nb-menu/ul/li[2]/ul/li[2]/a/span"));		
		//moving to the element define in xpath and clicking on it automatically
		...
		//matching with the checkout page url
			Assert.assertEquals(newUrl, "http://localhost:82/#/pages/user-management/create-user" );
