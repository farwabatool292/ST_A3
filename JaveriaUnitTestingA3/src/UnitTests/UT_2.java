...
//Search the Store Management section from the Home page of Store Adminstration 
		...
		// Searching the button of Store list  and perform click on it which will redirect it to the store page
		WebElement c1=driver.findElement(By.xpath("/html/body/ngx-app/div/ngx-pages/ngx-sample-layout/nb-layout/div/div/div/nb-sidebar[1]/div/div/nb-menu/ul/li[3]/ul/li[2]/a/span"));
